...
class EditTasksScreen extends StatefulWidget {
  const EditTasksScreen({Key? key, required this.taskCategory, required this.taskTitle}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: ResConfig.screenWidth / 20,),
              Text('Edit Task', style: GoogleFonts.poppins(color: purpleText, fontSize: 25, fontWeight: FontWeight.w600),),
              SizedBox(height: ResConfig.screenWidth / 20,),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(widget.taskTitle, style: GoogleFonts.poppins(color: menuText, fontSize: 16, fontWeight: FontWeight.w600)),
              ...
              Row(
                children: [
                  Text(widget.taskCategory, style: GoogleFonts.poppins(color: purpleText, fontSize: 14, fontWeight: FontWeight.w600 ),),
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 5,),
                  Text('Send Abel final designs for review',style: GoogleFonts.poppins(color: lightGreyText, fontSize: 13, fontWeight: FontWeight.w500 ), ),
               ],
              ),
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 5,),
                  Text('14:00 - 15:00',style: GoogleFonts.poppins(color: greyText, fontSize: 13, fontWeight: FontWeight.w500 ), ),
                  Spacer(),
                  SwitchWidget(),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 2,),
                  Text('30 minutes before',style: GoogleFonts.poppins(color: greyText, fontSize: 13, fontWeight: FontWeight.w500 ), ),
                  Spacer(),
                  SwitchWidget(),
                ],
              ),
              ...
              GestureDetector(
                  ...
                  child: Center(child: GetStartedButton(color: Color(0xFF393c7A), text: 'Save changes', textColor: Color(0xFFFFFFFF))))
