  ...
  Widget build(BuildContext context) {
    ...
    child: Column(
        ...
        onTap: (){
          ...
          Text('Take a look at your first\nshared task', style: GoogleFonts.poppins(color: purpleText, fontSize: 25, fontWeight: FontWeight.w600),),
          SizedBox(height: ResConfig.screenHeight / 30),
          Text('You\'ll be able to get a clear view anytime\nyou click on the "Shared Tasks" feature' , style: GoogleFonts.poppins(color: greyText, fontSize: 14, fontWeight: FontWeight.w500)),
          SizedBox(height: ResConfig.screenHeight / 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Hub House Team',style: GoogleFonts.poppins(color: purpleText, fontSize: 15, fontWeight: FontWeight.w600)),
              Container(
                height: 30,
                  width: 28,
                  ...
                  child: Center(child: Text('5d', style: GoogleFonts.poppins(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w800),)))
          ...
          Align(
            alignment: Alignment.bottomCenter,
              child: const FeatureButtonBlue(route:  SharedCongrats(), text: 'Next')),
