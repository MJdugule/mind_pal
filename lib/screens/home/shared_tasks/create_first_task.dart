        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Create First Task', style: GoogleFonts.poppins(color: purpleText, fontSize: 25, fontWeight: FontWeight.w600),),
              ...
              TextFieldWidget(hintText: 'Give a title to your first task...',),
              SizedBox(height: ResConfig.screenHeight / 20),
              Text('Add Description (Optional)', style: GoogleFonts.poppins(color: menuText, fontSize: 15, fontWeight: FontWeight.w600)),
              TextFieldWidget(hintText: 'Provide some additional information...'),
              SizedBox(height: ResConfig.screenHeight / 30),
              Text('Members', style: GoogleFonts.poppins(color: menuText, fontSize: 15, fontWeight: FontWeight.w600)),
                 ...
                 children: [
                   ...
                   Spacer(),
                    InkWell(
                        ...
                        child: Icon(Icons.add_circle_outline, color: lightPurpleText,)),
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 10,),
                  Text('June 30 - July 4, 2022',style: GoogleFonts.poppins(color: greyText, fontSize: 13, fontWeight: FontWeight.w500 ), ),
                ],
              ),
              ...
              SizedBox(height: ResConfig.screenHeight / 40),
               ...
               child: Container(
                 ...
                 }, child: Text('Create Task', style: GoogleFonts.poppins(color: Color(0xFFFFFFFF), fontSize: 16, fontWeight: FontWeight.w500)),
