      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(Icons.arrow_back, color: Color(0XFF393C7A),),
              SizedBox(height: ResConfig.screenHeight / 20,),
              Text('Verify your Email', style: GoogleFonts.poppins(color: Color(0xFF393C7A), fontSize: 28, fontWeight: FontWeight.w600),),
              SizedBox(height: ResConfig.screenHeight / 20,),
              ...
              Text('sashaoghenefego19@gmail.com', style: GoogleFonts.poppins(color: Color(0xFF333333), fontSize: 16, fontWeight: FontWeight.w700),),
